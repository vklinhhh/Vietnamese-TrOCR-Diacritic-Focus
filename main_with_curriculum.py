...
from curriculum_trainer import train_vietnamese_ocr_with_curriculum
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Train Vietnamese OCR model with curriculum learning')
    
    # Dataset and model parameters
    parser.add_argument('--dataset_name', type=str, default='vklinhhh/vietnamese_character_diacritic_cwl',
                        help='HuggingFace dataset name')
    parser.add_argument('--output_dir', type=str, default='vietnamese-trocr-diacritics-curriculum',
    ...
    parser.add_argument('--wandb_project', type=str, default='vietnamese-trocr-curriculum',
    ...
    if args.use_curriculum:
        print("Using curriculum learning for training")
        trained_model = train_vietnamese_ocr_with_curriculum(
            model=model,
        ...
        # Import the regular trainer if not using curriculum
        from trainer import train_vietnamese_ocr
        print("Using standard training (no curriculum)")
